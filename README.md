...
<table>
  <tr>
    <td width="50%" align="center" valign="top">
      ...
      <a href="https://khssdsg-maker.github.io/ai-toolbox/#modules">
        <img src="docs/assets/arena.jpg" alt="AI 大模型分屏打擂台" width="100%" style="border-radius: 8px; border: 1px solid #30363d;">
      </a>
      <p align="left">
    ...
    <td width="50%" align="center" valign="top">
      ...
      <a href="https://khssdsg-maker.github.io/ai-toolbox/#modules">
        <img src="docs/assets/arbiter.jpg" alt="独立总审官大模型双轮协同研判中枢" width="100%" style="border-radius: 8px; border: 1px solid #30363d;">
      </a>
      <p align="left">
  ...
  <tr>
    <td width="50%" align="center" valign="top">
      <h3>📚 视窗 ③：AI 提示词灵感宝典</h3>
      <a href="https://khssdsg-maker.github.io/ai-toolbox/#modules">
        <img src="docs/assets/prompts.jpg" alt="AI 提示词灵感宝典" width="100%" style="border-radius: 8px; border: 1px solid #30363d;">
      </a>
      <p align="left">
  ...
  <tr>
    <td width="50%" align="center" valign="top">
      ...
      <a href="https://khssdsg-maker.github.io/ai-toolbox/#modules">
        <img src="docs/assets/fav-video-player.jpg" alt="视频收藏与应用内原生直接播放" width="100%" style="border-radius: 8px; border: 1px solid #30363d;">
      </a>
      <p align="left">
    ...
    <td width="50%" align="center" valign="top">
      ...
      <a href="https://khssdsg-maker.github.io/ai-toolbox/#modules">
        <img src="docs/assets/convert.jpg" alt="Convertio 300+ 格式文件转换" width="100%" style="border-radius: 8px; border: 1px solid #30363d;">
      </a>
      <p align="left">
  ...
  <tr>
    <td colspan="2" align="center" valign="top">
      ...
      <a href="https://khssdsg-maker.github.io/ai-toolbox/#modules">
        <img src="docs/assets/drivers.jpg" alt="官方驱动中心与精选网络工具" width="100%" style="border-radius: 8px; border: 1px solid #30363d;">
      </a>
      <p align="left">
...
```mermaid
flowchart LR
    subgraph S1 [第一阶段：原始作答与初审]
        direction TB
        P[用户输入原始提示词] --> M1[模型 A: DeepSeek R1]
        P --> M2[模型 B: Claude 3.5]
        P --> M3[模型 C: 通义千问]
        M1 & M2 & M3 --> Pool[主屏原始答卷池]
        Pool --> Arbiter1[独立总审官：第一轮初审诊断]
    end

    subgraph S2 [第二阶段：定向深化与终极交付]
        direction TB
        Arbiter1 --> Split[专属任务母名模糊切片]
        Split -->|定向注入任务 A| M1
        Split -->|定向注入任务 B| M2
        Split -->|定向注入任务 C| M3
        M1 & M2 & M3 --> Pool2[主屏二轮深化答卷]
        Pool2 --> Arbiter2[独立总审官：终极融合裁决]
        Arbiter2 --> Masterpiece[🏆 终极单一融合成品交付]
        Arbiter2 --> SystemPrompt[⚡ 动态提炼 Cursor/Cline Agent 提示词]
    end
