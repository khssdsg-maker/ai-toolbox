...
const DRIVER_DATA: DriverCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'realtek', title: 'Realtek 驱动', titleEn: 'Realtek', href: 'https://www.realtek.com/zh/downloads', description: '瑞昱声卡网卡官方驱动', descriptionEn: 'Realtek official drivers', enabled: true },
    ],
  },
  {
    ...
    items: [
      ...
      { id: 'mchose', title: '迈从驱动', titleEn: 'MCHOSE', href: 'https://www.mchose.cn/', description: '迈从键盘鼠标国内官方下载中心与固件升级', descriptionEn: 'MCHOSE official China download center', enabled: true },
      { id: 'inphic', title: '英菲克驱动', titleEn: 'Inphic', href: 'http://www.inphic.cn/', description: '英菲克鼠标键盘国内官方驱动与软件中心', descriptionEn: 'Inphic official China drivers', enabled: true },
      { id: 'logitech', title: '罗技驱动', titleEn: 'Logitech G', href: 'https://www.logitechg.com.cn/zh-cn/innovation/g-hub.html', description: '罗技 G 中国官方驱动（G HUB 与板载内存管理器）', descriptionEn: 'Logitech G HUB official China', enabled: true },
      { id: 'razer', title: '雷蛇驱动', titleEn: 'Razer', href: 'https://www.razer.com.cn/synapse-3', description: '雷蛇中国官方驱动（雷云3 与固件更新）', descriptionEn: 'Razer Synapse 3 China', enabled: true },
      { id: 'rapoo', title: '雷柏驱动', titleEn: 'Rapoo', href: 'https://www.rapoo.com.cn/', description: '雷柏键鼠中国官方驱动下载与服务中心', descriptionEn: 'Rapoo official drivers', enabled: true },
      { id: 'dareu', title: '达尔优驱动', titleEn: 'Dareu', href: 'https://www.dareu.com.cn/', description: '达尔优外设中国官方驱动与固件下载中心', descriptionEn: 'Dareu official China drivers', enabled: true },
      { id: 'a4tech', title: '双飞燕 / 血手幽灵', titleEn: 'A4Tech / Bloody', href: 'http://www.a4tech.com.cn/', description: '双飞燕与血手幽灵国内官方驱动中心', descriptionEn: 'A4Tech / Bloody official drivers', enabled: true },
    ],
  },
  {
    id: 'driver-tools',
